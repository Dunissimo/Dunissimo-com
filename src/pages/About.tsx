    ...
    <div className="container px-6 pt-8 font-text">
      ...
      <div className="text-lg">
        ...
        <p className="mt-4">
          ...
          единственным фронтендером, что грустно, ведь мне хочется команду +
          ...
          каналов. С середины августа 2023 попал в некоммерческий стартап
          "Sakura" в роли Frontend разработчика. Наконец-то команда! Небольшая,
          ...
          недель. Продолжаем пилить наш проект.
        </p>
