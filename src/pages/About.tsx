  ...
  return (
    <div className="container px-6 pt-8 font-text">
      ...
      <div className="text-lg">
        ...
        <p className="mt-4">
          Шарписты, если вы это увидите, за текст выше не бейте, дело давнее,
          терминологию и всякие такие проблемы не знаю. Писал, как чувствовал.
        </p>
        ...
        <p className="mt-4">
          ...
          но все же. Мне понравилась роль преподавателя, в какой-то степени.
        </p>

        <p className="mt-4">
          Насчёт коммерческого опыта. Побывал в небольшом стартапе, где я был
          единственным фронтендером, что грустно, ведь мне хотелось команду +
          более опытных коллег. Там я занимался переносом с нативного JS на
          React и внедрением новых фич. Проработал недолго, у стартапа начались
          проблемы с финансами, как я понял. Это был сервис по анализу телеграм
          каналов. 
          
          С середины августа 2023 попал в некоммерческий стартап
          "Sakura" в роли Frontend разработчика. Делаем социальную сеть. Наконец-то команда! Небольшая,
          но команда. С напарником создали проект с нуля, настроили vite,
          поговорили про архитектуру, сделали базовый фундамент, в общем. Потом
          я занялся разработкой UI библиотеки на основе shadcn. Ушло около двух
          недель. После UI я разрабатывал функционал друзей: вёрстка, соединение с бэкендом.
        </p>

        <h2 className="font-bold text-xl my-6">Доп. опыт</h2>
        <p className="mt-4">
          Пробовал себя в backend. Ведь иметь сайт, который ты полностью сделал
          сам, намного круче, чем просто взять готовый API и написать под
        ...
        <p className="mt-4">
          ...
          Постепенно до всего этого дойду. Много текста вышло, но зато всё
          искренне. Буду рад оценке моего "сайта-портфолио", особенно по части
          дизайна.
        </p>
      </div>
    </div>
